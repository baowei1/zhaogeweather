...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=83cfeb3d288249bfb2b672817a98fc06";
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        for (Forcecast forcecast: weather.forcecastList){
            ...
            maxText.setText(forcecast.temperature.max);
            minText.setText(forcecast.temperature.min);
